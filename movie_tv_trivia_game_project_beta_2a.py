...
if name:
    ...
    print(f" Hello {name}, welcome to the TV/Movie Trivia Game! Given a famous quote, pick the correct answer.\n")
else:
...
answer = input(f"Do you want to end our game session {name}? (yes or no)\n")

if answer in ("yes", "y"):
    print(f"Awww, sorry to see you go. Thanks for playing {name}, please come back again!")

else:
    print(f"That's great {name}, let's restart the game again!\n")
    run_quiz(quotes)
